...
alias fly-nsx-s="fly -t $CONCOURSE_TARGET set-pipeline -p $PIPELINE_NAME -c ../../nsx-t-datacenter-ci-pipelines/pipelines/nsx-t-install.yml -l nsx-pipeline-config.yml"
